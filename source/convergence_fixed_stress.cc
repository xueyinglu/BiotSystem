...
using namespace std;
bool BiotSystem::convergence_fixed_stress(int fs_count)
{
    ...
    double l2_error = sqrt(residual);
    cout << "fixed stress convergence criteria l2 error = " << l2_error << endl;
    return (l2_error > tol_fixed_stress);
}